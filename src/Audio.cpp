...
void Audio::processWebStream()
{
    ...
    if (f_stream)
        lostStreamDetection(availableBytes);
...
int Audio::sendBytes(uint8_t *data, size_t len)
{
    ...
    case CODEC_OGG_FLAC:
        ret = FLACDecode(data, &bytesLeft, m_outBuff);
        break; // FLAC webstream wrapped in OGG
    default:
    {
